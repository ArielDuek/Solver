...
namespace solver{
    ...
    public:
        ...
        friend polinom operator ^ (polinom A, int e){
        ...
        friend polinom operator * (polinom A, polinom B){  // b1r+c1 * b2r+c2
        ...
        friend polinom operator / (polinom A, polinom B){ //  b1*r+c1 / b2*r+c2   ->   (b1/b2)*r+(c1/c2)
...
//==================================================================================
    ...
    double solve(RealVariable::polinom r){return r.getX()->real;}
    complex<double> solve(ComplexVariable::complexPolinom x){return x.getX()->img;}
